...
\begin{figure}[h!]
	\begin{center}
		\includegraphics[width=0.5\linewidth]{imgs/res2}
	\end{center}
	\caption{Triangulated mesh of one of our group members using one camera.}
	\label{fig:wireframe}
\end{figure}

\begin{figure}[h!]
	\begin{center}
		\includegraphics[width=0.5\linewidth]{imgs/res1}
	\end{center}
	\caption{Reconstructed surface of one of our group members using one camera.}
	\label{fig:res1}
\end{figure}

\begin{figure}[h!]
	\begin{center}
		\includegraphics[width=0.5\linewidth]{imgs/res3}
	\end{center}
	\caption{Reconstructed surface of one of our group members using all three cameras. We see the artifacts that arise in the parts where the pointclouds of the cameras overlap (face).}
