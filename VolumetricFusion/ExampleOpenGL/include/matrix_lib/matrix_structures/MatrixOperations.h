...
namespace matrix_lib {
	...
	CPU_AND_GPU auto add2(const A& a, const B& b) {
		return makeTuple(
			a[I<0>()] + b[I<0>()],
			a[I<1>()] + b[I<1>()]
		);
	...
	template<typename A, typename B>
	CPU_AND_GPU auto add3(const A& a, const B& b) {
		return makeTuple(
			a[I<0>()] + b[I<0>()],
			a[I<1>()] + b[I<1>()],
			a[I<2>()] + b[I<2>()]
	...
	template<typename A, typename B>
	CPU_AND_GPU auto add4(const A& a, const B& b) {
		return makeTuple(
			a[I<0>()] + b[I<0>()],
			a[I<1>()] + b[I<1>()],
			a[I<2>()] + b[I<2>()],
	 ...
	 */
	template<typename A, typename B>
	CPU_AND_GPU auto sub2(const A& a, const B& b) {
		return makeTuple(
			a[I<0>()] - b[I<0>()],
			a[I<1>()] - b[I<1>()]
		);
	...
	template<typename A, typename B>
	CPU_AND_GPU auto sub3(const A& a, const B& b) {
		return makeTuple(
			a[I<0>()] - b[I<0>()],
			a[I<1>()] - b[I<1>()],
			a[I<2>()] - b[I<2>()]
	...
	template<typename A, typename B>
	CPU_AND_GPU auto sub4(const A& a, const B& b) {
		return makeTuple(
			a[I<0>()] - b[I<0>()],
			a[I<1>()] - b[I<1>()],
			a[I<2>()] - b[I<2>()],
	 ...
	 */
	template<typename A, typename B>
	CPU_AND_GPU auto mul2(const A& a, const B& b) {
		return makeTuple(
			a[I<0>()] * b[I<0>()],
			a[I<1>()] * b[I<1>()]
		);
	...
	template<typename A, typename B>
	CPU_AND_GPU auto mul3(const A& a, const B& b) {
		return makeTuple(
			a[I<0>()] * b[I<0>()],
			a[I<1>()] * b[I<1>()],
			a[I<2>()] * b[I<2>()]
	...
	template<typename A, typename B>
	CPU_AND_GPU auto mul4(const A& a, const B& b) {
		return makeTuple(
			a[I<0>()] * b[I<0>()],
			a[I<1>()] * b[I<1>()],
			a[I<2>()] * b[I<2>()],
	 ...
	 */
	template<typename A, typename B>
	CPU_AND_GPU auto div2(const A& a, const B& b) {
		return makeTuple(
			a[I<0>()] / b[I<0>()],
			a[I<1>()] / b[I<1>()]
		);
	...
	template<typename A, typename B>
	CPU_AND_GPU auto div3(const A& a, const B& b) {
		return makeTuple(
			a[I<0>()] / b[I<0>()],
			a[I<1>()] / b[I<1>()],
			a[I<2>()] / b[I<2>()]
	...
	template<typename A, typename B>
	CPU_AND_GPU auto div4(const A& a, const B& b) {
		return makeTuple(
			a[I<0>()] / b[I<0>()],
			a[I<1>()] / b[I<1>()],
			a[I<2>()] / b[I<2>()],
	...
	CPU_AND_GPU auto shift2(const V& v, const C& c) {
		return makeTuple(
			v[I<0>()] + c,
			v[I<1>()] + c
		);
	...
	template<typename V, typename C>
	CPU_AND_GPU auto shift3(const V& v, const C& c) {
		return makeTuple(
			v[I<0>()] + c,
			v[I<1>()] + c,
			v[I<2>()] + c
	...
	template<typename V, typename C>
	CPU_AND_GPU auto shift4(const V& v, const C& c) {
		return makeTuple(
			v[I<0>()] + c,
			v[I<1>()] + c,
			v[I<2>()] + c,
	 ...
	 */
	template<typename V, typename C>
	CPU_AND_GPU auto scale2(const V& v, const C& c) {
		return makeTuple(
			v[I<0>()] * c,
			v[I<1>()] * c
		);
	...
	template<typename V, typename C>
	CPU_AND_GPU auto scale3(const V& v, const C& c) {
		return makeTuple(
			v[I<0>()] * c,
			v[I<1>()] * c,
			v[I<2>()] * c
	...
	template<typename V, typename C>
	CPU_AND_GPU auto scale4(const V& v, const C& c) {
		return makeTuple(
			v[I<0>()] * c,
			v[I<1>()] * c,
			v[I<2>()] * c,
	 ...
	 */
	template<typename A, typename B>
	CPU_AND_GPU auto dot2(const A& a, const B& b) {
		return a[I<0>()] * b[I<0>()] + a[I<1>()] * b[I<1>()];
	}

	template<typename A, typename B>
	CPU_AND_GPU auto dot3(const A& a, const B& b) {
		return a[I<0>()] * b[I<0>()] + a[I<1>()] * b[I<1>()] + a[I<2>()] * b[I<2>()];
	}

	template<typename A, typename B>
	CPU_AND_GPU auto dot4(const A& a, const B& b) {
	 ...
	 */
	template<typename A, typename B>
	CPU_AND_GPU auto cross3(const A& a, const B& b) {
		const auto a0 = a[I<0>()];
		const auto a1 = a[I<1>()];
		const auto a2 = a[I<2>()];
		const auto b0 = b[I<0>()];
	 ...
	 */
	template<typename A, typename B>
	CPU_AND_GPU auto add2x2(const A& a, const B& b) {
		return makeTuple(
			a[I<0>()] + b[I<0>()],
			a[I<1>()] + b[I<1>()],
			a[I<2>()] + b[I<2>()],
	...
	template<typename A, typename B>
	CPU_AND_GPU auto add3x3(const A& a, const B& b) {
		return makeTuple(
			a[I<0>()] + b[I<0>()],
			a[I<1>()] + b[I<1>()],
			a[I<2>()] + b[I<2>()],
	...
	template<typename A, typename B>
	CPU_AND_GPU auto add4x4(const A& a, const B& b) {
		return makeTuple(
			a[I<0>()] + b[I<0>()],
			a[I<1>()] + b[I<1>()],
			a[I<2>()] + b[I<2>()],
	 ...
	 */
	template<typename A, typename B>
	CPU_AND_GPU auto sub2x2(const A& a, const B& b) {
		return makeTuple(
			a[I<0>()] - b[I<0>()],
			a[I<1>()] - b[I<1>()],
			a[I<2>()] - b[I<2>()],
	...
	template<typename A, typename B>
	CPU_AND_GPU auto sub3x3(const A& a, const B& b) {
		return makeTuple(
			a[I<0>()] - b[I<0>()],
			a[I<1>()] - b[I<1>()],
			a[I<2>()] - b[I<2>()],
	...
	template<typename A, typename B>
	CPU_AND_GPU auto sub4x4(const A& a, const B& b) {
		return makeTuple(
			a[I<0>()] - b[I<0>()],
			a[I<1>()] - b[I<1>()],
			a[I<2>()] - b[I<2>()],
	 ...
	 */
	template<typename A, typename B>
	CPU_AND_GPU auto mul2x2(const A& a, const B& b) {
		return makeTuple(
			a[I<0>()] * b[I<0>()],
			a[I<1>()] * b[I<1>()],
			a[I<2>()] * b[I<2>()],
	...
	template<typename A, typename B>
	CPU_AND_GPU auto mul3x3(const A& a, const B& b) {
		return makeTuple(
			a[I<0>()] * b[I<0>()],
			a[I<1>()] * b[I<1>()],
			a[I<2>()] * b[I<2>()],
	...
	template<typename A, typename B>
	CPU_AND_GPU auto mul4x4(const A& a, const B& b) {
		return makeTuple(
			a[I<0>()] * b[I<0>()],
			a[I<1>()] * b[I<1>()],
			a[I<2>()] * b[I<2>()],
	 ...
	 */
	template<typename A, typename B>
	CPU_AND_GPU auto div2x2(const A& a, const B& b) {
		return makeTuple(
			a[I<0>()] / b[I<0>()],
			a[I<1>()] / b[I<1>()],
			a[I<2>()] / b[I<2>()],
	...
	template<typename A, typename B>
	CPU_AND_GPU auto div3x3(const A& a, const B& b) {
		return makeTuple(
			a[I<0>()] / b[I<0>()],
			a[I<1>()] / b[I<1>()],
			a[I<2>()] / b[I<2>()],
	...
	template<typename A, typename B>
	CPU_AND_GPU auto div4x4(const A& a, const B& b) {
		return makeTuple(
			a[I<0>()] / b[I<0>()],
			a[I<1>()] / b[I<1>()],
			a[I<2>()] / b[I<2>()],
	...
	CPU_AND_GPU auto shift2x2(const M& m, const C& c) {
		return makeTuple(
			m[I<0>()] + c,
			m[I<1>()] + c,
			m[I<2>()] + c,
	...
	template<typename M, typename C>
	CPU_AND_GPU auto shift3x3(const M& m, const C& c) {
		return makeTuple(
			m[I<0>()] + c,
			m[I<1>()] + c,
			m[I<2>()] + c,
	...
	template<typename M, typename C>
	CPU_AND_GPU auto shift4x4(const M& m, const C& c) {
		return makeTuple(
			m[I<0>()] + c,
			m[I<1>()] + c,
			m[I<2>()] + c,
	 ...
	 */
	template<typename M, typename C>
	CPU_AND_GPU auto scale2x2(const M& m, const C& c) {
		return makeTuple(
			m[I<0>()] * c,
			m[I<1>()] * c,
			m[I<2>()] * c,
	...
	template<typename M, typename C>
	CPU_AND_GPU auto scale3x3(const M& m, const C& c) {
		return makeTuple(
			m[I<0>()] * c,
			m[I<1>()] * c,
			m[I<2>()] * c,
	...
	template<typename M, typename C>
	CPU_AND_GPU auto scale4x4(const M& m, const C& c) {
		return makeTuple(
			m[I<0>()] * c,
			m[I<1>()] * c,
			m[I<2>()] * c,
	 ...
	 */
	template<typename A, typename B>
	CPU_AND_GPU auto mv2x2(const A& m, const B& v) {
		const auto v0 = v[I<0>()];
		const auto v1 = v[I<1>()];
	...
	template<typename A, typename B>
	CPU_AND_GPU auto mv3x3(const A& m, const B& v) {
		const auto v0 = v[I<0>()];
		const auto v1 = v[I<1>()];
		const auto v2 = v[I<2>()];
	...
	template<typename A, typename B>
	CPU_AND_GPU auto mv4x4(const A& m, const B& v) {
		const auto v0 = v[I<0>()];
		const auto v1 = v[I<1>()];
		const auto v2 = v[I<2>()];
		const auto v3 = v[I<3>()];
	 ...
	 */
	template<typename A, typename B>
	CPU_AND_GPU auto mm2x2(const A& a, const B& b) {
	...
	template<typename A, typename B>
	CPU_AND_GPU auto mm3x3(const A& a, const B& b) {
	...
	template<typename A, typename B>
	CPU_AND_GPU auto mm4x4(const A& a, const B& b) {
	 ...
	 */
	template<typename M>
	CPU_AND_GPU auto det2x2(const M& m) {
		return m[I<0>()] * m[I<3>()] - m[I<1>()] * m[I<2>()];
	}

	template<typename M>
	CPU_AND_GPU auto det3x3(const M& m) {
	...
	template<typename M>
	CPU_AND_GPU auto det4x4(const M& m) {
	 ...
	 */
	template<typename M>
	CPU_AND_GPU auto invert2x2(const M& m) {
	...
	template<typename M>
	CPU_AND_GPU auto invert3x3(const M& m) {
		using T = typename BaseType<M>::type;
	...
	template<typename M>
	CPU_AND_GPU auto invert4x4(const M& m) {
		using T = typename BaseType<M>::type;
	...
	CPU_AND_GPU void assign2(const In& input, Out& output) {
		output[I<0>()] = input[I<0>()];
		output[I<1>()] = input[I<1>()];
	}

	template<typename In, typename Out>
	CPU_AND_GPU void assign3(const In& input, Out& output) {
		output[I<0>()] = input[I<0>()];
		output[I<1>()] = input[I<1>()];
	...
	template<typename In, typename Out>
	CPU_AND_GPU void assign4(const In& input, Out& output) {
		output[I<0>()] = input[I<0>()];
		output[I<1>()] = input[I<1>()];
		output[I<2>()] = input[I<2>()];
	...
	template<typename In, typename Out>
	CPU_AND_GPU void assign2x2(const In& input, Out& output) {
		output[I<0>()] = input[I<0>()];
		output[I<1>()] = input[I<1>()];
		output[I<2>()] = input[I<2>()];
		output[I<3>()] = input[I<3>()];
	...
	template<typename In, typename Out>
	CPU_AND_GPU void assign3x3(const In& input, Out& output) {
		output[I<0>()] = input[I<0>()];
		output[I<1>()] = input[I<1>()];
		output[I<2>()] = input[I<2>()];
		output[I<3>()] = input[I<3>()];
	...
	template<typename In, typename Out>
	CPU_AND_GPU void assign4x4(const In& input, Out& output) {
		output[I<0>()]  = input[I<0>()];
		output[I<1>()]  = input[I<1>()];
		output[I<2>()]  = input[I<2>()];
		output[I<3>()]  = input[I<3>()];
