%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% TUM-Vorlage: Plakat A4 Hochformat
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
% Rechteinhaber:
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\input{./Ressourcen/Plakat/PraeambelA4Hoch.tex} % !!! NICHT ENTFERNEN !!!
...
\renewcommand{\PlakatBeschreibungBeispielbild}{false}
\input{./PlakatBeschreibung.tex}
...
\vspace{-\baselineskip}%
\PlakatBildGanzseitig[0cm 14cm 0cm 0cm]{./Ressourcen/_Bilder/SternenhimmelHochkant.jpg}{Bildunterschrift, Autor etc}
